      ...
      <nav class="navbar navbar-expand-sm fw-bold">
        <div class="container">
          <a href="../index.html" class="navbar-brand">
            <img
              src="https://www.hyundai.com/static/images/hyu_logo_og_image.jpg"
              width="150"
              class=""
              alt=""
            />
          ...
          <div class="collapse navbar-collapse d-flex-md justify-content-between" id="collapseId">
            <div class="navbar-nav">
              <a href="./surveyPage.html" class="nav-link">설문지 작성</a>
              <div class="dropdown">
                <a
                  href=""
                ...
                <div class="dropdown-menu">
                  <a href="./result.html" class="dropdown-item">전체 통계</a>
                  <a href="./client_result.html" class="dropdown-item">회원별 통계</a>
                  <a href="./removePage.html" class="dropdown-item">통계 삭제</a>
                </div>
              </div>
            </div>
            <div class="navbar-nav" >
              <a href="./logpage.html" class="nav-link">로그인/회원가입</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-2">
            <img src="../현대차량로고.png" width="50" alt="" />
          </div>
